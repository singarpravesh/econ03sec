...
In this project we shall consider the data from NASA about land-ocean temperature anomalies in the northern hemisphere. Figure \@ref(fig:1) is constructed using this data and shows temperatures in northern hemisphere over the period 1880-2016, expressed as differences from the average temperature from 1951-1980.
...
1. You now have charts for three different time intervals: month, season, and year. For each time interval, discuss what we can learn about patterns in temperature over time that we might not be able to learn from the charts of other time intervals.
