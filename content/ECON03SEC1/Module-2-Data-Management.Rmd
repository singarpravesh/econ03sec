...
## 2.2 Importig and editing data from text files/documents.
This lecture will focus on importing data from text files and editing text data.


- Download the file [Lineupsch38.xlsx](Lineupsch38.xlsx) that is used in the video and practice.
